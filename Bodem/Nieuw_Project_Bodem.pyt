...
import warnings  # <-- Voeg dit toe

# Onderdruk de irritante tempfile waarschuwingen
warnings.filterwarnings("ignore", category=ResourceWarning)  # <-- Voeg dit toe
...
class MaakNieuwProject(object):
    ...
    def execute(self, parameters, messages):
        ...
        # -------------------------------------------------
        TEMPLATE_WEBMAP_ID = "921da48329aa4c4db69a4619b75c22d0"
        ...
        GROUP_IDS = [
            "a046abb8ae9845c38d3f6adcb6cc7a73",
            "ba69206fefcf424c8be32d563e1fd5d4"
        ]
        target_groups = []
